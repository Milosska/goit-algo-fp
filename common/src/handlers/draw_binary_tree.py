...
def add_edges(graph, node, pos, x=0, y=0, layer=1):
    """Рекурсивно додає ребра до графа для візуалізації бінарного дерева."""
    if node is not None:
        graph.add_node(
...
def draw_tree(tree_root):
    """Візуалізує бінарне дерево за допомогою matplotlib та networkx."""
    tree = nx.DiGraph()
    ...
    print(
        "Бінарне дерево побудовано. Для продовження роботи програми закрийте вікно з візуалізацією."
    )
    plt.show()
